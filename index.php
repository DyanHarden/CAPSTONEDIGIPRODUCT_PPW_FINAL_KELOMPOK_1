...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto fs-4"><a href="index.php">Green Culture</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#cta">Article</a></li>
          <li><a class="nav-link active" href="code/loginuser.php">Login</a></li>
        </ul>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <a href="#kontenco2" class="btn-get-started animate__animated animate__fadeInUp scrollto">Selengkapnya</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <a href="code/loginuser.php" class="btn-get-started">Join Us!</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/67248-ilustrasi-hari-bumi-pexelsarthem-podrez.jpg" class="img-fluid" alt="" />
          </div>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center">
          <div class="col-lg-4 col-md-6 content-item">
            <h4 class="fw-bold ms-2" style="color: #5cb874">Visi:</h4>
          ...
          <div class="col-lg-4 col-md-6 content-item">
            <h4 class="fw-bold ms-2" style="color: #5cb874">Misi:</h4>
            <ul class="text-lg-start">
              <li>
    ...
    <!-- ======= Hasil Artikel Section ======= -->
    <section id="cta" class="cta">
      <div class="container">
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            <h3>Artikel dari Para Pahlawan Green Culture</h3>
            <p>
              Anda dapat melihat berbagai hasil pemikiran dan ilmu yang telah dibagikan oleh para relawan dalam bentuk tulisan, cobalah untuk belajar dan melihat berbagai cara untuk mengurangi emisi secara baik dan benar.
            </p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="code/lihatartikel.php">Lihat Sekarang</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="preview py-5" id="kontenco2">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mt-3">
              <img src="assets/img/tips5.jpeg" class="card-img-top" alt="Edukasi Emisi Kendaraan" />
              <div class="card-body shadow-sm">
                ...
                <a href="code/education.php" class="btn btn-success">Baca Selengkapnya</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card mt-3">
              ...
              <div class="card-body shadow-sm">
                ...
                <a href="code/calculator.php" class="btn btn-success">Hitung Sekarang</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card mt-3">
              ...
              <div class="card-body shadow-sm">
                ...
                <a href="code/tips.php" class="btn btn-success">Lihat Tips</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15958.746666974946!2d117.152498!3d-0.4654559999999999!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df67f4bb8b9dcd1%3A0x6fd5d38233261f93!2sUniversitas%20Mulawarman!5e0!3m2!1sid!2sus!4v1714050787237!5m2!1sid!2sus" width="600" height="450" style="border: 0; width: 100%; height: 290px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
